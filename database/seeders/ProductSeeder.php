...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            'stock' => 100,
            'description' => "The next-generation APS-C sensor delivers ultra-detailed photos, even in the brightest and most shaded areas. The world's fastest Live View autofocus * ensures razor-sharp images, even when subjects are moving quickly.",
            'status' => 1
        ]);
        ...
        Product::create([
            ...
            'stock' => 100,
            'description' => "32.5 Megapixel APS-C CMOS sensor. Dual Pixel autofocus (live view/video) 45-point all cross-type AF (through the viewfinder) 220k-pixel metering sensor w/face detection.",
            'status' => 1
        ]);
