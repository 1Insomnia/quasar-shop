                ...
                <form class="w-full overflow-hidden space-y-8 max-w-2xl md:px-12 md:py-8 md:shadow-xl md:space-y-12"
                    ...
                    <div>
                        <div class="outline relative border-2 focus-within:border-primary-dark">
                            <input type="first_name" name="first_name" placeholder=" " id="first_name"
                            ...
                            <label for=" first_name" class="absolute top-0 text-lg bg-white p-4 -z-1 duration-300 origin-0">
                                First Name
                            </label>
                        </div>
                        @error('first_name')
