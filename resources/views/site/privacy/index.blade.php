...
@section('content')
    <section class="container px-5">
        <div class="space-y-12">
            <article class="">
                <h1 class="text-primary-dark font-bold text-3xl md:text-4xl lg:text-6xl py-12 lg:py-24">Privacy Policy for Quasar Optic</h1>
                <div class="py-4">
                    <p>At Quasar Optic, accessible from quasar-optic.com, one of our main priorities is
                        the privacy of our
                        visitors.
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        ...
                        with
                        regards
                        to the information that they shared and/or collect in Quasar Optic. This policy is not
                        applicable to
                        any
                        information collected offline or via channels other than this website. Our Privacy Policy was
                        created
                        with the
                        help of the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Online
                            Generator
                            of
                            Privacy
                            Policy</a>.</p>
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">Consent</h2>
                <div class="py-4">
                    <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
                </div>
            </article>
            <article>
                <h2 class="text-primary-dark  text-2xl">Information we collect</h2>
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">How we use your information</h2>
                ...
                <div class="py-4">
                    ...
                    <ul>
                        ...
                        <li>Communicate with you, either directly or through one of our partners, including for
                            customer
                            service, to
                            provide you with updates and other information relating to the website, and for
                            marketing
                            and
                            promotional
                            purposes
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">Log Files</h2>
                <div class="py-4">
                    <p>Quasar Optic follows a standard procedure of using log files. These files log
                        visitors when they
                        visit
                        websites.
                        ...
                        by
                        log files
                        include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date
                        and
                        time
                        stamp,
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">Cookies and Web Beacons</h2>
                <div class="py-4">
                    <p>Like any other website, Quasar Optic uses 'cookies'. These cookies are used to
                        store information
                        including
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">Advertising Partners Privacy Policies</h2>
                <div class="py-4">
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        ...
                        are
                        used in
                        their respective advertisements and links that appear on Quasar Optic, which are sent directly
                        to
                        users'
                    ...
                    <p>Note that Quasar Optic has no access to or control over these cookies that are used by
                        third-party
                        advertisers.</p>
                </div>
            </article>
            <article>
                <h2 class="text-primary-dark  text-2xl">Third Party Privacy Policies</h2>
                <div class="py-4">
                    <p>Quasar Optic's Privacy Policy does not apply to other advertisers or websites.
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">CCPA Privacy Rights (Do Not Sell My Personal
                    Information)</h2>
                <div class="py-4">
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">GDPR Data Protection Rights</h2>
                <div class="py-4">
            ...
            <article>
                <h2 class="text-primary-dark  text-2xl">Children's Information</h2>
                <div class="py-4">
                    ...
                    <p>Quasar Optic does not knowingly collect any Personal Identifiable Information from children under
                        the
                        age
                        of 13.
