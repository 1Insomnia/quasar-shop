...
@section('title', 'Quasar Optic - User - Personnal Information')
    ...
    <section>
        <div class="container px-5 min-h-screen py-12">
            ...
            <form class="w-full overflow-hidden space-y-8 max-w-2xl md:px-12 md:py-8 md:shadow-xl md:space-y-12"
                method="POST" action="{{ route('user.profile.update', auth()->user()->id) }}">
                @method('PATCH')
                @csrf
                ...
                <div class="flex items-center space-x-4 mt-2 py-6">
                    <button class="relative text-sm inline-block text-primary-dark outline-none focus:outline-none active"
