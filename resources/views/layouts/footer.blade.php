<footer class="text-neutral-light bg-gray-100 body-font">
    <div
        ...
        <div class="text-center flex flex-grow flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-center">
            ...
            <div class="w-full md:w-1/2">
                ...
                <nav class="list-none mb-10">
                    ...
                    <li>
                        <a href="#" class="text-gray-600 hover:text-primary-dark">Undercover</a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-600 hover:text-primary-dark">Agent</a>
                    </li>
                </nav>
            </div>
        </div>
    ...
    <div class="bg-gray-200">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-primary-dark text-sm text-center sm:text-left">
                © 2020 Quasar Optic
            </p>
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                ...
                <a href="#" class="ml-3 text-primary-dark">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        class="w-5 h-5" viewBox="0 0 24 24">
                        <path
